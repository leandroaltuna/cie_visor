...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'CIE';
$config['webmaster_email'] = 'no-reply@cenpesco.e-proyectos.org';
...
$config['recaptcha_public_key'] = '6Lea8eASAAAAAE-T-Ciss729WSYx1cpNJ-UuT3KC';
$config['recaptcha_private_key'] = '6Lea8eASAAAAAFuHtBN92Cef21yrYI9qIGntaIHb';
